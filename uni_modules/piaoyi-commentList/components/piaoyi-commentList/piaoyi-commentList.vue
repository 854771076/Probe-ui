	...
	<view class="commentcomponent">
		<view v-for="(item, index) in apprises" :key="index" class="commentitem">
			<view class="comment_top">
				<image class="headpic" :src="apiServer+item.photo ? apiServer+item.photo: require('./person_default.png')">
				</image>
				<view class="content">
					...
					<view style="display: flex;align-items: center;justify-content: space-between;">
						...
						<text class="cm_time">{{timeformet(item.last_update)}}</text>
					</view>
				</view>
			</view>
			<view class="contents">
				...
				<view class="delete" v-if ="item.is_mine" @click="del(item.cid)">
					删除
				</view>
			</view>
		</view>
